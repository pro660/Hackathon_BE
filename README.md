...
취향 분석과 제품 추천에서 시작해 구매 전 활용 가능성 분석, 스마트 착용 추천, 장소 추천, 보유 제품 관리와 활용 지원까지 하나의 흐름으로 연결하는 것을 목표로 합니다.
...
| 스마트 착용 추천 | 제품과 조건을 기반으로 착용 추천 생성·저장 | 확정·미구현 |
...
| 활용 지원 | 활용도 분석, 다시 활용할 제품 안내 | 확정·미구현 |
